...
export const env = {
  ...
  monitoringActivityWindowHours: getOptionalNumberEnv("MONITORING_ACTIVITY_WINDOW_HOURS", 24),
  monitoringMissingLeadGraceMinutes: getOptionalNumberEnv("MONITORING_MISSING_LEAD_GRACE_MINUTES", 5),
  ...
  webPushPublicKey: getOptionalEnv("WEB_PUSH_PUBLIC_KEY"),
  webPushPrivateKey: getOptionalEnv("WEB_PUSH_PRIVATE_KEY"),
  webPushContact: getOptionalEnv("WEB_PUSH_CONTACT") ?? "mailto:relaynw@gmail.com",
