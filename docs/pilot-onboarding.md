...
capture, CRM access, or monthly billing.

## 4. Configure billing

- The one-time setup fee is $150 unless explicitly waived.
- Monthly service is $99 and can start after technical setup is `live`.
- Use Stripe Checkout to start payments.
